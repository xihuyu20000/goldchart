...
export const setLocalItem = async (data) => {
...
export const titleTextStyleFontFamilies = [
...
export const titleXAxisNameLocations = [
  { label: "start", value: "start" },
  { label: "center", value: "center" },
  { label: "end", value: "end" },
];
export const xAxisNameLocations = [
  { label: "左侧", value: "start" },
  { label: "中间", value: "center" },
  { label: "右侧", value: "end" },
];
export const yAxisNameLocations = [
...
export const seriesLineStyleTypes = [
  { label: "solid", value: "solid" },
  { label: "dashed", value: "dashed" },
  { label: "dotted", value: "dotted" },
];
export const seriesBarItemStyleBorderTypes = [
  { label: "solid", value: "solid" },
  { label: "dashed", value: "dashed" },
  { label: "dotted", value: "dotted" },
];
export const echartOptionColor = [
...
export const echartOptionGradientColor = [
...
export const echartOptionLabelPositions = [
